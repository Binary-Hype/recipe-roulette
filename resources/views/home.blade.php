       ...
       <!-- Hero -->
        <div class="hero min-h-[60vh]">
            <div class="hero-content text-center">
                <div class="max-w-lg">
                    ...
                    <p class="text-xl py-10">Entdecke es jetzt mit nur einem Klick und lass dich von neuen Geschmäckern inspirieren</p>
        ...
        <footer class="footer p-10 bg-neutral text-neutral-content">
            <aside>
                ...
                <p>Binary Hype<br>Web Development Wizard</p>
            </aside>
            <nav>
