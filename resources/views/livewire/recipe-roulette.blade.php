<div class="content">
    <div class="flex gap-3 justify-center mb-5">
        <label class="btn btn-neutral has-[:checked]:btn-primary cursor-pointer px-3">
            ...
            Tierisch
            <input type="radio" name="type" class="appearance-none"/>
        </label>
        <label class="btn btn-neutral has-[:checked]:btn-primary cursor-pointer px-3">
            <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <!--! Font Awesome Pro 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
        ...
        <label class="btn btn-neutral has-[:checked]:btn-primary cursor-pointer px-3">
            ...
            Vegan
            <input type="radio" name="type" class="appearance-none" checked/>
        </label>
    </div>

    <div class="flex justify-center">
        <label class="swap swap-flip mx-auto" x-data="{ preparation: false }">
            <input type="checkbox"/>
            <div class="swap-on" :class="{'h-0': !preparation}">
                <div class="card shadow-xl max-w-2xl" @click="preparation = ! preparation">
                    <figure>
                        <img class=""
                    ...
                    <div class="card-body">
                        <h2 class="card-title">Gulaschsuppe</h2>
