<div class="content">
            ...
            <label class="swap swap-flip mx-auto" x-data="{ instructions: false }">
                ...
                <div class="swap-on" :class="{'h-0': !instructions}">
                    ...
                    <div class="card shadow-xl max-w-2xl" @click="instructions = ! instructions">
                        <figure>
                            @if($recipe->cover)
                                <img class="w-[670px] max-w-full object-cover"
                                     src="{{ url('storage/' . $recipe->cover) }}"
                                     alt="{{ $recipe->name }}"/>
                            @else
                                <img class="w-[670px] max-w-full object-cover" src="/img/placeholder.webp"
                                     alt="{{ $recipe->name }}"/>
                            @endif
                        </figure>
                        ...
                        <div class="card-body">
                            ...
                            <div class="prose prose-li:marker:text-[#1FCC79]">{!!  $recipe->instructions !!}</div>
    ...
    @else
        <div class="flex justify-center">
            <div>
                <span class="text-sm text-neutral-500">* Bilder können vom eigentlichen Gericht abweichen</span>
                <div class="card shadow-xl max-w-2xl">
                    <figure>
                        <img class="w-[670px] max-w-full object-cover" src="/img/placeholder.webp"
                             alt="Platzhalter"/>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="grid grid-cols-1 sm:grid-cols-2 gap-x-3 gap-y-3">
                            ...
                            <li>1 Handvoll Neugier</li>
                            <li>Ein Schuss Überraschung</li>
                            <li>1/2 Tasse gute Laune</li>
                            <li>Eine Messerspitze Chaos</li>
                        </ul>
                    </div>
                </div>
            </div>
